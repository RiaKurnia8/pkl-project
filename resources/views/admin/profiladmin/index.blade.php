...
@section('content')
    ...
    <section
        style="background-color: #f3f4f6; padding: 15px; border-radius: 6px; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
        ...
        <form method="POST" action="{{ route('profile.update') }}" class="mt-4 space-y-4">
            ...
            {{-- <div class="form-group mb-3">
                ...
                <input id="plant" name="plant" type="text" value="{{ old('plant', auth()->user()->plant) }}"
                    required
                    style="background-color: #d1d5db; border: none; padding: 8px; width: 100%; font-size: 14px; border-radius: 4px;"
                    readonly>
                @error('plant')
            ...
            <div class="form-group mb-3">
                ...
                <input id="nomor_hp" name="nomor_hp" type="text" value="{{ old('nomor_hp', auth()->user()->nomor_hp) }}"
                    required
                    style="border: 1px solid #d1d5db; padding: 8px; width: 100%; font-size: 14px; border-radius: 4px;">
                @error('nomor_hp')
                    <p style="color: red; font-size: 15px;">{{ $message }}</p>
            ...
            <div class="form-group mb-3">
                ...
                <select id="jenis_kelamin" name="jenis_kelamin" required
                    ...
                    <option value="Laki-laki"
                        {{ old('jenis_kelamin', auth()->user()->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
                    </option>
