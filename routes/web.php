...
Route::get('/user/profile', [ProfilUserController::class, 'edit'])->name('profile.edit');
Route::patch('/user/profile', [ProfilUserController::class, 'update'])->name('profile.update');
